...
const fetchdata=async()=>{
 ...
 const response=await fetch("https://newsapi.org/v2/top-headlines?country=in&apiKey=e15a87d942a840fca586073cfc8894c6&pageSize=10&page=1&category=sports")
...
window.addEventListener("scroll",()=>{
  ...
  if(window.innerHeight+document.documentElement.scrollTop+1>=document.documentElement.scrollHeight)
  {
    ...
    setTimeout(()=>{
      fetch(`https://newsapi.org/v2/top-headlines?country=in&apiKey=e15a87d942a840fca586073cfc8894c6&pageSize=10&page=${page}&category=sports`).then((res)=>res.json()).then((json)=>{
